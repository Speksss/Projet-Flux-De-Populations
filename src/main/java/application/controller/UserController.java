 ...
 */
@RestController
@Api(value = "fluxDePopulation", description = "Opérations relatives à la gestion basique des utilisateurs",
...
public class UserController {
    ...
    public ResponseEntity<List<User>> getAllUsersFiltered(@RequestParam(value = "active", required = false) Boolean active,
                                                      @RequestParam(value = "role", required = false) String role) {
        List<User> users = active != null && !active ?
                this.userService.findAllInactiveUsers()
        ...
        if(role != null && !role.equals(""))
            users.removeIf(user -> !user.hasRole(role));
    ...
    public ResponseEntity<String> register(@RequestParam("email") String email,
        ...
        if(user != null) {
            ...
            newUser.addRole(RoleType.ROLE_STUDENT);
    ...
    public ResponseEntity<String> deleteAdmin(@RequestParam("emailAdmin") String emailAdmin,
        ...
        if(userAdmin.hasRole(RoleType.ROLE_ADMIN)) {
            ...
            return new ResponseEntity<>("Vous n'avez pas l'autorisation pour effectuer cette opération.",
